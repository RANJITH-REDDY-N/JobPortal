          ...
          currentPageJobs.map((job) => (
            <div key={job.job_id} className={styles.jobCard}>
                ...
                <div className={styles.rightSection}>
                  <div className={styles.locationSalary}>
                    ...
                    <div className={styles.infoBlock}>
                      ...
                      <span>${parseFloat(job.job_salary).toLocaleString()} / yr</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.jobDescription}>
                ...
                >
                  {/* Added Job Description title */}
                  <div className={styles.jobInfoSection}>
                    <strong>Job Description</strong>
                    <p>{expandedJobId === job.job_id ? job.job_description : `${job.job_description.slice(0, 100)}...`}</p>
                  </div>
